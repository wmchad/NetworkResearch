...
## EDIT FOR YOUR JOB
## Request 4 CPUs (cores) on 2 nodes, 16 total cores
#PBS -l nodes=1:ppn=4,mem=22gb,feature=16core
...
source GetNearTowerEventData.sh /ischool/jb/roshan_anon/wmchad/Data/Events/FoundEventLocationMonth.txt 60
exit 0
